...
class IndexView(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            if (
                image.name.rfind(".png") != -1
                or image.name.rfind(".jpg") != -1
                or image.name.rfind(".jpeg") != -1
            ):
        ...
        if request.POST["algorithm"] == "standard":
            ...
            select = 1
        create_gaussian(
            image_width, image_height, float(sigma), "static/deconv/image/gaussian.png"
        )
        create_filtered(
            "static/deconv/image/" + filename,
